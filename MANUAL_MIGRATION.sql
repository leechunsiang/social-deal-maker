...
-- https://supabase.com/dashboard/project/jjrfayfncwljjcdwumho/sql

-- Step 1: Add fb_post_id column to scheduled_posts
...
-- Step 2: Create post_comments table
...
DROP POLICY IF EXISTS "Users can view comments on their own posts" ON public.post_comments;
