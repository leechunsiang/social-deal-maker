    ...
    <div className="flex-1 p-2 space-y-6 overflow-y-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div 
            ...
            className="bg-zinc-900/50 border border-white/5 rounded-2xl overflow-hidden backdrop-blur-sm flex flex-col min-h-[300px]"
        >
             <div className="p-6 border-b border-white/5 flex justify-between items-center">
                <h3 className="font-bold text-lg">Engagement Overview</h3>
                <select className="bg-zinc-800 border border-white/10 rounded-lg text-xs px-2 py-1 outline-none text-zinc-300">
                    <option>Last 30 days</option>
                </select>
            </div>
            <div className="flex-1 p-4">
                 <EngagementChart data={stats.dailyEngagement || []} />
            </div>
        </motion.div>
      </div>
    </div>
